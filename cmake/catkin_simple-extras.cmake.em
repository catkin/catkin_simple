...
macro(catkin_simple)
  if(TARGET ${PROJECT_NAME}_package)
    message(FATAL_ERROR "Could not create target '${${PROJECT_NAME}_package}' for project ${PROJECT_NAME}, as it already exists.")
  endif()
...
macro(cs_add_target_to_package)
  add_dependencies(${PROJECT_NAME}_package ${ARGV0})
  list(APPEND ${PROJECT_NAME}_TARGETS ${ARGV0})
endmacro()

macro(cs_add_executable _target)
  if(${_target} STREQUAL ${PROJECT_NAME}_package)
    message(FATAL_ERROR "Could not create executable with name '${_target}' as '${PROJECT_NAME}_package' is reserved for the top level target name for this project.")
  endif()
  ...
  cs_add_target_to_package(${_target})
endmacro()

macro(cs_add_library _target)
  if(${_target} STREQUAL ${PROJECT_NAME}_package)
    message(FATAL_ERROR "Could not create library with name '${_target}' as '${PROJECT_NAME}_package' is reserved for the top level target name for this project.")
  endif()
