...
macro(cs_add_executable _target)
  ...
  unset(cs_add_executable_args_UNPARSED_ARGUMENTS)
  unset(cs_add_executable_args_NO_AUTO_LINK)
  unset(cs_add_executable_args_NO_AUTO_DEP)
...
macro(cs_add_library _target)
  ...
  unset(cs_add_library_UNPARSED_ARGUMENTS)
  unset(cs_add_library_NO_AUTO_LINK)
  unset(cs_add_library_NO_AUTO_DEP)
  unset(cs_add_library_NO_AUTO_EXPORT)
  cs_add_targets_to_package(${_target})
endmacro()
