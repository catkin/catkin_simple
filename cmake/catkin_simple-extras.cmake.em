...
macro(cs_add_executable)
  if(STREQUAL ${PROJECT_NAME} ${ARGV0})
    set(${ARGV0} ${PROJECT_NAME}_exec)
  endif()
  list(APPEND ${PROJECT_NAME}_TARGETS ${ARGV0})
  add_executable(${ARGN})
  if(STREQUAL ${ARGV0} ${PROJECT_NAME}_exec)
    set_target_properties(${ARGV0} PROPERTIES OUTPUT_NAME ${PROJECT_NAME})
  endif()
...
macro(cs_add_library)
  if(STREQUAL ${PROJECT_NAME} ${ARGV0})
    set(${ARGV0} ${PROJECT_NAME}_lib)
  endif()
  list(APPEND ${PROJECT_NAME}_TARGETS ${ARGV0})
  list(APPEND ${PROJECT_NAME}_LIBRARIES ${ARGV0})
  add_library(${ARGN})
  if(STREQUAL ${ARGV0} ${PROJECT_NAME}_lib)
    set_target_properties(${ARGV0} PROPERTIES OUTPUT_NAME ${PROJECT_NAME})
  endif()
  target_link_libraries(${ARGV0} ${catkin_LIBRARIES})
  if(NOT "${${PROJECT_NAME}_CATKIN_BUILD_DEPENDS_EXPORTED_TARGETS}" STREQUAL "")
